  ...
  <?php foreach ($requests as $i => $request): ?>
      <tr>
        ...
        ?>
            ...
            <td>
                <a onclick="return confirm('This will overwrite the already submitted files. Are you sure?')" href="update.php?request_number=<?php echo $request['request_number'] ?>"  class="btn btn-sm btn-outline-primary">Edit Request</a>
                <br>
                <br>
